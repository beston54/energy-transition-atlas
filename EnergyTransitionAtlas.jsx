...
.scrollbar-hide { -ms-overflow-style: none; scrollbar-width: none; }`}</style>
      ...
      {/* ���── 3. Hero Section ─── */}
      <section ref={heroRef} className="bg-[#6B21A8] px-6 py-4 lg:py-5 overflow-hidden">
