...
const PRACTICES = [
  ...
  { id: 125, title: "Fish hotels", url: "https://offshore-coalition.eu/database-project/fish-hotels/", brand: "OCEaN", dim: "Nature", topic: "Offshore Energy & Nature", inf: "Offshore wind", year: 2021, country: "Netherlands", org: "Ecocean, TenneT", desc: "To enhance biodiversity around TenneT’s offshore high voltage station by creating shelter and safe foraging opportunities for diverse types ofyoung fish and potentially crustaceans.", img: "https://renewables-grid.eu/app/uploads/2026/02/2020_Database_50hertz_Jointinitiative2.jpg", award: false },
  ...
  { id: 149, title: "e-Gridmap", url: "https://renewables-grid.eu/database/e-gridmap/", brand: "RGI", dim: "Technology", topic: "Energy System Optimisation", inf: "Energy system", year: 2020, country: "Estonia", org: "Elering", desc: "Elering launched an innovative tool named e-Gridmap that immediately calculates the costs (CapEx and Return on Investment) of connecting a new renewable production facility to the Estonian transmission grid based on the project’s location and capacity, thus simplifying investments in renewable energy.", img: "https://renewables-grid.eu/fileadmin/user_upload/Elering_Map.png", award: false },
  { id: 150, title: "Ecological line maintenance in a nature reserve", url: "https://renewables-grid.eu/database/ecological-line-maintenance/", brand: "RGI", dim: "Nature", topic: "Integrated Vegetation Management", inf: "Grids", year: 2020, country: "Germany", org: "NABU; BUND", desc: "Three power lines run through the Ehinger Ried nature reserve in Baden-Württemberg, Germany. As with all power lines, for their maintenance, it is necessary to take steps to intervene and manage the vegetation.", img: "https://renewables-grid.eu/fileadmin/_processed_/csm_Screen_Shot_2021-03-26_at_10.25.51_880eb593ae.png, https://renewables-grid.eu/fileadmin/_processed_/csm_Screen_Shot_2021-04-06_at_16.19.24_8bca621bdf.png, https://renewables-grid.eu/fileadmin/_processed_/Screen_Shot_2021-04-06_at_16.19.35.png", award: false },
  { id: 151, title: "EmPower Your Environment grant programme", url: "https://renewables-grid.eu/activities/best-practices/database.html?detail=209", brand: "RGI", dim: "People", topic: "", inf: "Energy system", year: 2020, country: "", org: "PSE", desc: "", img: "https://renewables-grid.eu/fileadmin/_processed_/csm_Niemce_commune_2_a039bbea99.jpg", award: false },
  ...
  { id: 186, title: "Dynamic Line Rating demonstration on interconnectors", url: "https://renewables-grid.eu/activities/best-practices/database.html?detail=198", brand: "RGI", dim: "Technology", topic: "", inf: "Energy system", year: 2018, country: "", org: "Ampacimon", desc: "", img: "", award: false },
  ...
  { id: 193, title: "Natural High-Tech: The Great Scallop as an Environmental Sensor", url: "https://renewables-grid.eu/database/natural-high-tech/", brand: "RGI", dim: "Nature", topic: "Offshore Energy & Nature", inf: "Offshore wind", year: 2018, country: "France", org: "RTE, TBM Environment", desc: "This project is assessing whether temporarily increased turbidity and noise levels caused by the installation of new subsea cables have an impact on seabed ecosystems.", img: "https://renewables-grid.eu/fileadmin/user_upload/Screen_Shot_2018-05-02_at_13.00.15.png\nhttps://renewables-grid.eu/fileadmin/_processed_/c/5/csm_Screen_Shot_2018-05-02_at_12.16.46_bef7efea35.\nhttps://renewables-grid.eu/fileadmin/_processed_/7/b/csm_Screen_Shot_2019-06-13_at_10.43.57_01_7fa5703c7c.png", award: false },
  ...
  { id: 269, title: "Multi-stakeholder working groups", url: "https://renewables-grid.eu/database/multi-stakeholder/", brand: "RGI", dim: "Planning", topic: "Advocating for Optimised Grids", inf: "Grids", year: 2013, country: "Germany", org: "50Hertz,", desc: "To solve some of these challenges that arise with the implemenation of the new legislation on electricity grids in Germany, different working groups have been established. First of all, there is an overarching communication group at federal level, which consists of all four TSOs plus the regulator/permitting authority. In addition, groups for specific projects have […]", img: "https://renewables-grid.eu/app/uploads/2024/02/2024_Database_EirGrids-Community-Benefit-Fund.png", award: false },
  ...
  return (
    ...
    >
      <div
        ...
        tabIndex={-1}
        className="bg-[#FFF8E5] rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl outline-none max-sm:rounded-none max-sm:max-h-full max-sm:h-full max-sm:max-w-full"
      >
        {/* Header */}
