...
const PRACTICES = [
  ...
  { id: 70, title: "EconiQ retrofill for gas-insulated lines ELK-3, 420kV", url: "https://renewables-grid.eu/database/econiq-retrofill-for-gas-insulated-lines-elk-3-420kv/", brand: "RGI", dim: "Technology", topic: "Circularity & Supply Chains", inf: "Energy system", year: 2023, country: "Switzerland", org: "Hitachi Energy", desc: "Hitachi’s EconiQ retrofill solution replaces sulfur hexafluoride (SF6) in installed high-voltage gas-insulated lines and gas-insulted switchgear with an eco-efficient gas mixture to significantly lower the carbon footprint over the total installation life cycle. EconiQ retrofill eliminates the emissions of SF6 and the associated carbon footprint and avoids the costly decommissioning and replacement of equipment. Highlights […]", img: "https://renewables-grid.eu/app/uploads/2025/09/Hitachi_EconiQ1-scaled-644x398-c-default.jpeg", award: false },
  ...
  { id: 317, title: "Communication materials to address concerns on EMF", url: "https://renewables-grid.eu/database/communication-materials/", brand: "RGI", dim: "People", topic: "Creating Awareness & Capacity Building", inf: "Grids", year: 2010, country: "", org: "RTE", desc: "To respond to the concerns of citizens about the potential negative health impacts of EMF, RTE undertook several educational measures. Main Information First of all, a website has been established. Under the name “la clef des champs” (the key to the fields), RTE produces information for different interests. With the help of video clips, illustrations […]", img: "https://renewables-grid.eu/app/uploads/2026/03/2010_Database_RTE_CommunicationMaterials1-644x398-c-default.png", award: false },
  ...
  return (
    <div className="relative w-full max-w-[520px] mx-auto" style={{ aspectRatio: "500/440" }}>
      <style>{`
        ...
        @keyframes hero-cloud-drift-2 { 0%,100% { transform: translateX(0); } 50% { transform: translateX(-10px); } }
        ...
        @media (prefers-reduced-motion: no-preference) {
          ...
          .hero-cloud-2 { animation: hero-cloud-drift-2 18s ease-in-out infinite 3s; }
      ...
      `}</style>
      <svg viewBox="55 75 390 360" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" overflow="visible" aria-hidden="true">
        ...
        {/* ── Cloud 2 (repositioned upper-right) ── */}
        <g className="hero-cloud-2 hero-enter" style={{ animationDelay: "1.6s" }} opacity="0.22" transform="translate(-220,-140)">
          <path fill="#FFF8E5" d="M313.43,248.19l4.51-6.28c1.2-1.67,1.64-4.96.32-5.85-1.6-1.08-4.94.66-5.32,2.47-.22,1.06-.48,1.92-1,2.84l-1.07,1.87c-.43.76-1.49,1.3-2.32.72-.21-.49-.18-1.68.11-2.14l2.33-3.7c.18-.28.27-.71.18-.92-.76-1.63-8.93,3.92-9.57,8.83.84,1.61,1.37,3.09.85,4.78-.52.12-1.63.15-1.87-.21-1.19-1.76-.21-4.24-1.23-4.48-1.62-.39-3.16-.18-4.71.36-1.93.67-5.96,2.81-5.91,3.55,0,.14.31.39.49.46l7.31,2.66c.47.17.78.32,1.22.51l4.35,1.82,1.62.73,1.71.63,2.17.77,2.33.78,2.29.64c.92.26,1.91.07,2.78.59l.85-.28,3.67-.6.32-.47c.06-.09.49.07.46.18-.28.97-1.76,1.91-3.24,2.03-6.89.56-12.34-2.65-18.06-4.75l-10.68-3.91c-1.12-.41-1.81-1.99-.93-2.81,2.96-2.78,9.14-5.52,12.92-4.06,1.27-4.29,6.55-9.18,10.52-9.57.45-.04,1.28.6,1.72.91,1.58-1.1,3.4-2.39,5.44-1.91s2.88,2.75,2.53,4.53c-.39,1.95-1.13,3.47-2.21,5.04l-1.35,1.97-.95,1.57c2.99-.15,5.51-.97,7.14,1.13.33,1.09-.21,2.38-1.1,3.19l1.83.08c2.65.12,6.31.43,7.23,2.69,1.15,2.82-9.34,4.96-9.31,3.13,0-.29.31-.9.58-1l.83-.32c.2-.08.5.34.74.66,1.91-.24,3.84-.74,5.48-2.13-3.18-2.04-8.12-1.67-11.6-.51-3.03-1.35,1.89-1.93,3.99-4.95-.77-.67-1.54-.66-2.43-.65-5.35.07-5.89,2.15-7.27,2.59"/>
        </g>
        ...
        <g className="hero-el hero-enter" style={{ animationDelay: "0s" }} opacity="0.9">
        ...
        <g className="hero-el hero-enter" style={{ animationDelay: "0.6s" }} opacity="0.55">
          <g transform="translate(60, 20) scale(0.6)">
            <path fill="#FFF8E5" d="M289.11,242.08l-1.48-2.32-2.93-4.16-11.16,4.59-4.63,1.8-4.11,11.79c-.22.64-1.12,1.57-1.61,1.24l-1.22-.82,1.8-5.76,1.7-4.75,1.81-5.24,1.32-3.13,1.55-3.71,1.31-3.25,2.13-5.07,1.49-3.8,2.73-6.42,2.72-6.36,6.61-13.24,5.24-10.1-13.69-6.26-4.94-2.03c-.34-.14-.84-.3-1.01-.49s-.18-.83-.03-1.09c1.45-.48,3.24-.27,4.75-.31l8.85-.25,12.11-.6,3.99-6.6-9.32-3.46-4.18-1.27c-.99-.3-2.37-.34-2.93-1.5-.13-.28.5-.61.84-.62l5.33-.12,3.14-.22,6.67-.53,5.92-.59,1.23-1.7c2.36-3.78,4.54-7.6,7.54-10.87l3.36-3.66c.33-.36,1.53-.39,1.96-.13.25.86.61,2.06.48,2.89l-1.44,9.08-1.82,8.03c-.17.73.41,1.03.77,1.41l1.86,1.98,1.77,1.82,4.33,5.27,2.71,3.1c.7.8,1.92,1.96,1.71,3.07-.51.98-1.62,0-2.17-.24l-8.82-3.91-3.03-1.32-2.12-.45-1.68,6.51c.72,1.41,2.02,2.51,2.9,3.63l1.83,2.33,2.49,3.27,2.89,3.58c1.27,1.57,2.55,3.33,3.41,5.16l1.64,3.53c.22.48-.76,1.26-1.26.94l-1.77-1.11-5.97-2.68-10.56-4.84-.75,2.73-2.42,10.09-3.37,13.14-4.27,15.54-3.43,13.86-2.92,13.44-1.47,4.98c-.21.36-1.3.31-1.65.12-.39-.22-1.26-.91-1.14-1.43l.6-2.62,3.2-14.34-3.4-5.5Z"/>
          </g>
        </g>
