...
const PRACTICES = [
  ...
  { id: 186, title: "Dynamic Line Rating demonstration on interconnectors", url: "https://renewables-grid.eu/activities/best-practices/database.html?detail=198", brand: "RGI", dim: "Technology", topic: "", inf: "Energy system", year: 2018, country: "", org: "Ampacimon", desc: "", img: "https://renewables-grid.eu/app/uploads/2026/03/2018_Database_VSD_IntegratedVegetationManagement2.png", award: false },
  ...
  { id: 269, title: "Multi-stakeholder working groups", url: "https://renewables-grid.eu/database/multi-stakeholder/", brand: "RGI", dim: "Planning", topic: "Advocating for Optimised Grids", inf: "Grids", year: 2013, country: "Germany", org: "50Hertz,", desc: "To solve some of these challenges that arise with the implemenation of the new legislation on electricity grids in Germany, different working groups have been established. First of all, there is an overarching communication group at federal level, which consists of all four TSOs plus the regulator/permitting authority. In addition, groups for specific projects have […]", img: "", award: false },
